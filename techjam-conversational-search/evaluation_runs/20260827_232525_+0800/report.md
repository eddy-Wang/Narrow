...
LLM enabled: `True`  
Git commit: `b104ebdc0edde188d12dca79da82c62c9a960446`
...
| MTTC | 3.305000 |
| Efficiency | 0.769500 |
| Technical Score | 0.712612 |
| Prompt tokens | 477292 |
| Completion tokens | 85125 |

## Scenario breakdown

| Scenario | Samples | Hit Rate | MRR | MTTC |
|---|---:|---:|---:|---:|
| boundary | 10 | 0.900000 | 0.250397 | 3.400000 |
| browsing | 80 | 0.887500 | 0.349782 | 3.525000 |
| buying | 80 | 0.912500 | 0.341156 | 2.437500 |
| intent_override | 30 | 0.900000 | 0.489854 | 5.000000 |
...
- Asked attribute: `brand`
- Semantic query: `Shoes mules and clogs`
- Target rank this turn: `None`
...
- Asked attribute: `style`
- Semantic query: `Women's fashion hoodies and sweatshirts made of 90% cotton and 10% other materials with pull-on closure`
- Target rank this turn: `None`
- Candidate counts: `{"lexical_candidates": 300, "dense_candidates": 200, "attribute_candidates": 200, "fused_candidates": 500, "filtered_candidates": 500, "ranked_candidates": 500}`
...
- Top recommendations: `B06XRFSDL4` **(target)**, `B09KH2L6KX`, `B08MDVYQ5H`, `B07ZVF8S3X`, `B07H4LBDCS`
...
**Agent:** The current matches mainly differ by use case: winter, work, outdoor. Which do you prefer?
