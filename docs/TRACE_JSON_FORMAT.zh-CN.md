...
[English (primary)](TRACE_JSON_FORMAT.md) · [测试与产物入口](TESTING.zh-CN.md) · [前端启动（英文）](../demo-frontend/README.md)
...
1. 在工作台运行历史打开该次运行的 Trace；或从[产物目录](TESTING.zh-CN.md)找到 Native 的 `trace.json`。
